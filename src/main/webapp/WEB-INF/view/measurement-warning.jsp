...
<div class="body-container">
    ...
    <div class="container-fluid">
        ...
        <div class="row content" id="wrapper">
            ...
            <div class="col-sm-9" id="center" style="top: 30%;">

                <form:form method="post" action="addMeasurementWarning">
                    ...
                    <table style="text-align: left;
                            ...
                            <td>
                                <h3>
                                    <span class="label label-warning">
                                        W przeslanym pliku, znajduja sie dane, ktorych wartosci <br>
                                        sa w znacznym stopniu odrozniajace sie od pozostalych. <br>
                        ...
                        <tr>
                            <td>
                                <button type="submit" class="btn btn-success">Dodaj pomiar</button>
                            </td>
                        </tr>
